    ...
    <div class="bg-muted flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
        <div class="flex w-full max-w-md flex-col gap-6">
            <a href="<?php echo e(route('home')); ?>" class="flex flex-col items-center gap-2 font-medium" wire:navigate>
                <?php
                $logo = \App\Models\Setting::get('public_logo');
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logo && Storage::disk('public')->exists($logo)): ?>
                <img src="<?php echo e(Storage::url($logo)); ?>" alt="<?php echo e(config('app.name')); ?>" class="h-12 w-auto mb-1" />
                <?php else: ?>
...
</html><?php /**PATH C:\laragon\www\carecloudStatus\resources\views/components/layouts/auth/card.blade.php ENDPATH**/ ?>